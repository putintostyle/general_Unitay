function example2b
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% In this example, we are working on a perturbation with value 1e-6.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
m_list = [5, 3, 2, 5, 6]; % m_list = [m_1, m_2, ..., m_r] 3\leq m_i\leq 4
n_list = m_list;
...
%     A = kron(A, A0);
% end
load('low_square_example1.mat', 'A');
...
for trails = 1:TRnum
    ...
    for j = 1:r
        ...
        matrx = rand(m_list(j), n_list(j))+I*rand(m_list(j), n_list(j));
...
ylabel('residuals')
saveas(gcf,'square_example_2')
saveas(gcf,'square_example_2','epsc')
...
saveas(gcf,'square_example_2_1e_6')
saveas(gcf,'square_example_2_1e_6','epsc')
...
saveas(gcf,'square_example_2bar_1e_6')
saveas(gcf,'square_example_2bar_1e_6','epsc')
...
% % 
% % %  saveas(gcf,'square_example_2_closest')
% % %  saveas(gcf,'square_example_2_closest','epsc')
